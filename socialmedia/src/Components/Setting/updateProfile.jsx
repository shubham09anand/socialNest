...
const UpdateProfile = () => {
  ...
  return (
    <>
      <ToastContainer />
      {userProfile ? (
        <form className="border-l w-full lg:w-[80%] lg:p-2 lg:absolute right-0 lg:pt-[30px]" onSubmit={handleSubmit}>
          ...
          <div className="flex md:gap-8 gap-4 pb-5 items-center md:p-8 md:pt-4 p-6 md:pb-4 border-b space-x-5">
            <div className="relative md:w-20 md:h-20 w-20 h-20 shrink-0">
              ...
              <label htmlFor="file" className="md:p-1 p-0.5 rounded-full bg-slate-600 border-4 border-white absolute -bottom-2 -right-2 cursor-pointer">
            ...
            <div className="relative md:w-20 md:h-20 w-20 h-20 shrink-0">
              ...
              <label htmlFor="file1" className="md:p-1 p-0.5 rounded-full bg-slate-600 border-4 border-white absolute -bottom-2 -right-2 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="md:w-4 md:h-4 w-5 h-5 fill-white">
                  <path d="M12 9a3.75 3.75 0 100 7.5A3.75 3.75 0 0012 9z"></path>
                  <path fillRule="evenodd" d="M9.344 3.071a49.52 49.52 0 015.312 0c.967.052 1.83.585 2.332 1.39l.821 1.317c.24.383.645.643 1.11.71.386.054.77.113 1.152.177 1.432.239 2.429 1.493 2.429 2.909V18a3 3 0 01-3 3h-15a3 3 0 01-3-3V9.574c0-1.416.997-2.67 2.429-2.909.382-.064.766-.123 1.151-.178a1.56 1.56 0 001.11-.71l.822-1.315a2.942 2.942 0 012.332-1.39zM6.75 12.75a5.25 5.25 0 1110.5 0 5.25 5.25 0 01-10.5 0zm12-1.5a.75.75 0 100-1.5.75.75 0 000 1.5z" clipRule="evenodd" ></path>
                </svg>
            ...
            <div className="bg-white w-full p-4 px-4 md:p-8 mb-6 space-y-2">
              ...
              <div className="w-full sm:flex sm:space-x-10">
                <div className="w-full">
                  ...
                  <input onChange={(e) => setFirstName(e.target.value)} value={firstName} type="text" name="Fname" id="Fname" className="h-10 border mt-1 focus:outline-[#6f90e2] focus:border-none bg-gray-100 focus:bg-gray-50 rounded px-2 sm:px-4 w-full outline-none focus:border-black" placeholder="Jhon" required />
                </div>

                <div className="w-full">
                  <label htmlFor="Lname"> Last Name <span className="text-red-700">*</span></label>
                  <input onChange={(e) => setLastName(e.target.value)} value={lastName} type="text" name="Lname" id="Lname" className="h-10 border mt-1 focus:outline-[#6f90e2] focus:border-none bg-gray-100 focus:bg-gray-50 rounded px-2 sm:px-4 w-full outline-none focus:border-black" placeholder="Patrik" required />
                </div>
              </div>
              ...
              <div className="w-full sm:flex sm:space-x-10">
                <div className="w-full">
                  ...
                  <input onChange={(e) => setPhone(e.target.value)} value={phone} type="text" maxLength="10" name="phone" id="phone" pattern="[0-9]*" className="h-10 border mt-1 focus:outline-[#6f90e2] focus:border-none bg-gray-100 focus:bg-gray-50 rounded px-2 sm:px-4 w-full outline-none focus:border-black" placeholder="7623569909" />
                </div>
                ...
                <div className="w-full">
                  ...
                  <input onChange={(e) => setBirthday(e.target.value)} value={birthday} type="text" name="birthday" id="birthday" className="h-10 border mt-1 focus:outline-[#6f90e2] focus:border-none bg-gray-100 focus:bg-gray-50 rounded px-2 sm:px-4 w-full outline-none focus:border-black" required placeholder="DD-MM-YYYY" pattern="\d{2}-\d{2}-\d{4}" />
                </div>
              </div>
              ...
              <div className="sm:flex sm:space-x-5 w-full justify-between">
                <div className="w-full">
                  ...
                  <input onChange={(e) => setCity(e.target.value)} value={city} type="text" name="city" id="city" className="h-10 border mt-1 focus:outline-[#6f90e2] focus:border-none bg-gray-100 focus:bg-gray-50 rounded px-2 sm:px-4 w-full outline-none focus:border-black" placeholder="City" />
                </div>

                <div className="w-full">
                  <label htmlFor="address">State</label>
                  <input onChange={(e) => setState(e.target.value)} value={state} type="text" name="address" id="address" className="h-10 border mt-1 focus:outline-[#6f90e2] focus:border-none bg-gray-100 focus:bg-gray-50 rounded px-2 sm:px-4 w-full outline-none focus:border-black" placeholder="State" />
                </div>
              ...
              <div className="w-full">
                <div className="w-full">
                  ...
                  <input onChange={(e) => setYouare(e.target.value)} value={youare} type="text" name="youare" id="youare" className="h-10 border mt-1 focus:outline-[#6f90e2] focus:border-none bg-gray-100 focus:bg-gray-50 rounded px-2 sm:px-4 w-full outline-none focus:border-black" placeholder="Profess..." required />
                </div>

                <div className="w-full mt-1">
                  <label htmlFor="studied"> Studied At</label>
                  <input onChange={(e) => setStudied(e.target.value)} value={studied} type="text" name="studied" id="studied" className="h-10 border mt-1 focus:outline-[#6f90e2] focus:border-none bg-gray-100 focus:bg-gray-50 rounded px-2 sm:px-4 w-full outline-none focus:border-black" placeholder="Collage" />
                </div>
              </div>

              <div className="">
                <label htmlFor="description">Description <span className="text-red-700">*</span></label>
                <textarea maxLength={200} onChange={(e) => setDescription(e.target.value)} value={description} type="text" name="description" id="description" className="transition-all flex items-center py-2 resize-none h-24 border mt-1 rounded px-2 sm:px-4 w-full bg-gray-50 outline-none focus:border-black" placeholder="" required />
              </div>

              <button disabled={button} type="submit" className={`active:opacity-75 bg-[#6f90e2] hover:bg-[#405ba0] text-white font-semibold py-2 px-4 rounded ${button ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}>Save Changes</button>
