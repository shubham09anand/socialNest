                ...
                <header className="fixed w-screen bottom-0 lg:top-0 lg:bottom-[100%] bg-white z-40">
                    <div className="flex py-1 justify-between border-t-2 w-full pr-2 lg:px-6 lg:gap-5 space-x-2 place-content-center items-center bg-white">
                        <div className={` lg:hidden w-fit flex items-center gap-1 ${logedin_user_Id === null ? 'hidden' : 'block'}`}>
                            {!hamburgerDisplay && (
                                <button onClick={handleDashboardDisplay} className={`${logedin_user_Id === null ? 'hidden' : 'flex items-center justify-center w-8 h-8 text-xl rounded-full hover:bg-gray-100'}`} aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="black" className="w-6 h-6  outline-none">
                            ...
                            {hamburgerDisplay && (
                                <button onClick={handleDashboardDisplay} className={`${logedin_user_Id === null ? 'hidden' : 'flex items-center justify-center w-8 h-8 text-xl rounded-full hover:bg-gray-100'}`} aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6  outline-none">
