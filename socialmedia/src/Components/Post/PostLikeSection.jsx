...
import { handleLikeIncrDcr } from './PostFunctoion';

const PostLikeSection = ({postId, likedBy, index, postTotalLike, postTotalComments}) => {
     return (
          <div className='flex space-x-5'>
               <div id={index + 'postLike'} className="sm:p-2 flex items-center gap-4 text-xs font-semibold">
                    <div onClick={() => { handleLikeIncrDcr(postId, likedBy, index) }}>
