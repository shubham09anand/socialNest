...
const SendGroupMessage = () => {
     ...
     return (
          <>
               ...
               <div className="lg:w-[80%] border-t backdrop-blur-xl right-0 z-10 pb-12 lg:pb-0 fixed items-center  bottom-0 w-full example">
                    <form className="w-full pt-1 items-center gap-1">
