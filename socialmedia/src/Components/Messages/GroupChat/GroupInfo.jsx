...
const GroupInfo = ({ display, setDisplay, groupInfo ,groupName, groupDesc, isLoading }) => {

     return (
          <div className="flex fixed w-full lg:w-[80%] right-0 bg-white items-center justify-between gap-2 px-3 z-10 border-b border-gray-400 py-2 example">
               <div className="flex space-x-4 place-content-center items-center text-start pb-0 text-sm">
                    ...
                    </Link>
                    {
                         isLoading ? (
                              <div className='animate-pulse  flex place-content-center items-center space-x-3'>
                                   ...
                                   <div className='space-y-2'>
                                        ...
                                        <div className='w-36 h-2 rounded-full bg-gray-500/50'></div>
                                   </div>
                              </div>
                         ) : (
                         ...
                         <div>
                              ...
                              <div className="text-gray-500 text-sm">{groupDesc}</div>
                         </div>
                    </Link>
                         )
                    }
