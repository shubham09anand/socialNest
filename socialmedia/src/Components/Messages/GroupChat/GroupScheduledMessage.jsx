...
const GroupScheduledMessage = ({ display, setDisplay }) => {
     ...
     return (
          true && (
               ...
               <div className={`overflow-y-scroll border-y-0 h-[calc(100%-110px)] sm:h-[calc(100%-160px)] md:h-[calc(100%-160px)] pb-10 shadow-inner border-black border-l bg-white fixed z-10 sm:z-0 right-0 top-16 lg:top-28 transition-all duration-500 ${display === 1 ? 'px-4 w-full sm:w-1/2 lg:w-2/4 xl:w-[27%]' : 'w-0'}`}>
                    <ToastContainer />

                    <div className='overflow-y-scroll relative'>
                         {display === 1 && (
                              <div className='z-50 flex w-full sm:w-1/2 lg:w-2/4 xl:w-[27%] justify-between place-content-center items-center h-fit sm:fixed bg-white'>
                                   <h2 className="text-2xl w-fit  pb-2 sm:leading-snug tracking-wide font-bold pt-3">Schedule Message</h2>
                              </div>
                         )}
                         ...
                         <div style={{ outline: "none" }} className="  outline-none overflow-y-scroll ">
                              ...
                              <div className="pt-0 text-xs font-normal py-0 px-2">
                                   <div className="w-full space-y-2 py-2 ">
                                        ...
                                        < button className={`text-white bg-[#4b5e9b] active:bg-[#2e489b] focus:ring-4 focus:outline-none rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center font-semibold ${true ? "cursor-not-allowed" : "cursor-pointer"}`}>Set Message</button>
                                   </div>
                              </div>
                         </div>
                              ...
                              <div key={index} className='space-y-2'>
                                   <div className='w-full overflow-hidden border-b'>
                                        <div className='w-full flex space-x-5'>
                                             ...
                                             <div className="block font-sans text-lg font-thin">Will Be Deliver At</div>
                                        </div>
                                        <div className={`flex mt-2 overflow-hidden ${selectedMessage === index ? 'h-fit' : 'h-0'}`}>
                                             <div className='-ml-1'>
                                             ...
                                             <div className="block font-sans text-lg font-thin"> Lorem ipsum dolor sit amet. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illum dignissimos omnis eligendi suscipit tempore esse at minus dicta deserunt reprehenderit! </div>
                                        </div>

                                        {selectedMessage === index && (<div className='w-fit h-fit mx-auto my-2'><button className={`px-4 py-1 w-fit h-fit mx-auto text-center mt-2 text-white font-semibold rounded-sm bg-[#2a448a] hover:bg-[#436fe8] ${true ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}>Cancel</button></div>)}
