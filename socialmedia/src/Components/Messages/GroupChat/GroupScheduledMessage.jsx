...
const GroupScheduledMessage = ({ display }) => {
     ...
     return (
          ...
          <>
               ...
               <div className={`overflow-y-scroll border-y-0 h-[calc(100%-110px)] sm:h-[calc(100%-160px)] md:h-[calc(100%-160px)] pb-40 shadow-inner border-black border-l bg-white fixed z-10 sm:z-0 right-0 top-16 lg:top-28 transition-all duration-500 ${display === 1 ? 'w-full sm:w-1/2 lg:w-2/4 xl:w-[27%]' : 'w-0'}`}>
