...
import { createPost } from "./CommunityPostFunction";

const CretaeGroupPost = ({ display }) => {
     ...
     return (
          <div className={`${display === 1 ? 'translate-x-0' : 'translate-x-full'} duration-500 w-3/4 relative mb-5 overflow-hidden mx-auto p-7 pt-0 rounded-lg`}>
               <div className="space-y-5">
                    ...
                    <div style={{ backgroundImage: `url(${addPattern})` }} className='border-[#42579d] border-2 shadow-xl rounded-md'>
